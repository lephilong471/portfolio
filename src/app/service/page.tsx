...
import { MUIBox, MUIListItemText, MUICollapse, MUIList, MUIGrid, MUITypography, MUIButton } from "@/components/MUI";
...
const Service = () => {
   ...
   const listExpandData = [
      [
         {
            title: "Warehouse Rental Service",
            content:
               "Hai Sam Company's shared warehouse rental service is an efficient and cost-effective storage solution for businesses that need to store goods but do not want to invest in a private warehouse. With a warehouse system of over ...m2 in ..., customers will benefit from modern facilities, stringent security systems, and professional management. Sharing warehouse space not only helps save costs but also provides flexibility in inventory management, making it particularly suitable for small and medium-sized enterprises. Hai Sam is always ready to support customers in every step, from receiving and storing to transporting goods. By choosing Hai Sam's shared warehouse rental service, customers will have a safe, convenient, and efficient storage solution, allowing them to focus resources on their core business activities.",
         },
         {
            title: "Transportation Services (Road, Sea, Air)",
            content:
               "Hai Sam Company proudly offers comprehensive transportation services to meet all customer shipping needs. With an experienced team and a large fleet of transportation vehicles, Hai Sam ensures your goods are delivered quickly and safely. We provide transportation services by air, road, and sea, serving both domestic and international needs. Our fleet of trucks and container vehicles is always ready to handle any transportation requirements, from small shipments to large projects. Hai Sam is committed to delivering efficient, cost-effective, and time-saving transportation solutions, allowing you to focus on your core business activities with peace of mind.",
         },
         {
            title: "Import-Export Services",
            content:
               "Hai Sam Company provides professional import-export services to help businesses optimize their international trade processes. With deep expertise in customs procedures and regulations, we ensure swift and accurate handling of your orders. Hai Sam's experienced and highly skilled staff are always ready to advise and support customers throughout the import-export process. We are committed to delivering effective import-export services that save time and costs, enhancing your competitive edge in the international market. By choosing Hai Sam's import-export services, customers will benefit from optimal solutions, including consulting, customs clearance, and professional and reliable handling of transportation and delivery.",
         },
         {
